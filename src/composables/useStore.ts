...
const initialState = (): GameState => ({
  ...
  devices: {
    ...
    thermometer: { known: true, seen: false },
    fireplace: { known: true, seen: false },
    radio: { known: true, seen: false },
    candles: { known: true, seen: false },
    mirror: { known: true, seen: false },
    bathtub: { known: true, seen: false },
    computerGame: { known: true, seen: false },
    ectoplasm: { known: false, seen: false },
  },
