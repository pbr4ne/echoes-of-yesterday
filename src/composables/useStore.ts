...
const initialState = (): GameState => ({
  ...
  research: {
    ...
    paranormal: {
      ...
      divination: { visible: true, known: true, seen: false, complete: false },
      aeromancy: { visible: true, known: true, seen: false, complete: false },
      cartomancy: { visible: true, known: true, seen: false, complete: false },
      tasseomancy: { visible: true, known: true, seen: false, complete: false },
      ...
      spectroscopy: { visible: true, known: true, seen: false, complete: false },
      astralProjection: { visible: true, known: true, seen: false, complete: false },
      entheogens: { visible: true, known: true, seen: false, complete: false },
      automaticWriting: { visible: true, known: true, seen: false, complete: false },
      hermetechnics: { visible: true, known: true, seen: false, complete: false },
    },
  },
  modifiers: {
		decayMult: {},
