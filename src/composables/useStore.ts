...
const initialState = (): GameState => ({
  ...
  ghosts: {
    poltergeist: { state: 'Encountered', isActive: false, activeRoom: null, activeDuration: null, activationStart: null },
    orb: { state: 'Communicated', isActive: false, activeRoom: null, activeDuration: null, activationStart: null },
    wraith: { state: 'Communicated', isActive: false, activeRoom: null, activeDuration: null, activationStart: null },
    spirit: { state: 'Communicated', isActive: false, activeRoom: null, activeDuration: null, activationStart: null },
    phantom: { state: 'Communicated', isActive: false, activeRoom: null, activeDuration: null, activationStart: null },
  },
  pendingActions: [],
  log: [],
