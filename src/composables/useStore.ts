...
const initialState = (): GameState => ({
  ...
  devices: {
    bed: { known: true, seen: false },
    blackLight: { known: true, seen: false },
    candles: { known: true, seen: false },
    computer: { known: true, seen: false },
    journal: { known: true, seen: false },
    mirror: { known: true, seen: false },
    mushrooms: { known: true, seen: false },
    ouijaBoard: { known: true, seen: false },
    radio: { known: true, seen: false },
    shrine: { known: true, seen: false },
    tarot: { known: true, seen: false },
    teaKettle: { known: true, seen: false },
  ...
  research: {
    ...
    paranormal: {
      ...
      paranormal2: { visible: true, known: true, seen: false, complete: false },
      paranormal3: { visible: true, known: true, seen: false, complete: false },
      paranormal4: { visible: true, known: true, seen: false, complete: false },
      paranormal5: { visible: true, known: true, seen: false, complete: false },
      paranormal6: { visible: true, known: true, seen: false, complete: false },
      paranormal7: { visible: true, known: true, seen: false, complete: false },
      paranormal8: { visible: true, known: true, seen: false, complete: false },
      paranormal9: { visible: true, known: true, seen: false, complete: false },
      paranormal10: { visible: true, known: true, seen: false, complete: false },
      paranormal11: { visible: true, known: true, seen: false, complete: false },
      paranormal12: { visible: true, known: true, seen: false, complete: false },
      paranormal13: { visible: true, known: true, seen: false, complete: false },
      paranormal14: { visible: true, known: true, seen: false, complete: false },
      paranormal15: { visible: true, known: true, seen: false, complete: false },
      paranormal16: { visible: true, known: true, seen: false, complete: false },
      paranormal17: { visible: true, known: true, seen: false, complete: false },
    },
  },
  modifiers: {
		decayMult: {},
