...
const initialState = (): GameState => ({
  ...
  rooms: {
    ...
    kitchen: { known: false, locked: false },
    bedroom: { known: false, locked: false },
    sunroom: { known: false, locked: false },
    bathroom: { known: false, locked: false },
    den: { known: false, locked: false },
    crawlspace: { known: false, locked: true },
  },
  pendingActions: [],
  log: [],
