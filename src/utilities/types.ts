...
export type InventoryKey = 'food' | 'water' | 'tea' | 'sage' | 'ginger' | 'tomato' | 'potato' | 'carrot' | 'strawberry' | 'lemon' | 'fig' | 'sunflower' | 'chamomile' | 'lavender';
...
export type DeviceKey = 'ouijaBoard' | 'tv' | 'blackLight' | 'shrine' | 'ghostBook';
